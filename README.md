**Запуск из jar-файл из папки с проектом**
**java -jar TestTask_UnoSoft.jar lng.txt**
...
java -jar {название проекта}.jar тестовый-файл.txt (**java -jar TestTask_UnoSoft.jar lng.txt**)
